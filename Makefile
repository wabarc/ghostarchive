...
LDFLAGS := $(shell echo "-X 'github.com/wabarc/ghostarchive.Version=`git describe --tags --abbrev=0`'")
...
GOFILES ?= $(wildcard ./cmd/ghostarchive/*.go)
PROJECT := github.com/wabarc/ghostarchive
